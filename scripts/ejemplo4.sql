...
create table if not exists ventas_empleado_cliente as 
    SELECT
...
create table if not exists ventas_empleado_cliente_por_mes as 
    SELECT 
        store, 
        manager,
        customer,
...
create table if not exists ventas_comparativo as 
    SELECT 
        store,
        manager,
        customer, 
